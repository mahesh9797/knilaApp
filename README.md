...
2) Initially No user found will be shown.Using add conntact create new record.
...
5) For maps, openlayers is used. MARKERS placed based on entered CITY,So please add valid city like Salem, Coimbatore, Bangalore...etc. which is maintained in local city.json in assets.
6) The markers can be done based on address using paid google geocoding serice.
